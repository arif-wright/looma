...
Status: Phase 8C.2. Runtime parser: `src/lib/game/sprites/assetContract.ts`.
...
The required direction order is native art in clockwise world order: `n, ne, e, se, s, sw, w, nw`. Do not mirror directions unless a future manifest version explicitly permits it. Muse's asymmetric horns, wings, and tail make implicit mirroring unsafe.
