...
>
  ...
  >
    <div class="mx-auto flex max-w-md items-center justify-between gap-1 px-4">
      {#each items as item (item.href)}
        <a
          href={item.href}
          class={`group flex flex-1 flex-col items-center gap-1 rounded-2xl px-2.5 py-2 text-[11px] font-medium tracking-[0.08em] text-white/75 transition-colors duration-150 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-cyan-300/60 focus-visible:ring-offset-0 motion-reduce:transition-none ${
            isActive(item.href)
